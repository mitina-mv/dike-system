...
<body>
    ...
    @else
        ...
        <div style="margin-bottom: 15px;">
            <div>
                <b>Студент: </b>{{$student->user_lastname}} {{$student->user_firstname}} {{$student->user_patronymic}}
            </div>
            <div>
            ...
            <div>
                <b>Оценка за тест: </b><?= isset($testlog->testlog_mark) ? "{$testlog->testlog_mark} из 100" : 'не сдано'?>
            </div>
                    ...
                    <td>
                        ...
                        @switch($type)
                            @case('text')
                                ...
                                @elseif (
                                    isset($testlog->uncorrect_answers)
                                    && isset($testlog->uncorrect_answers[$answerlog->question->id])
                                )
